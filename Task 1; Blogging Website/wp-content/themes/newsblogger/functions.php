                ...
                <div class="dashboard-hero-panel">
                    <div class="hero-panel-content">
                        ...
                        <div class="theme-admin-button-wrap theme-admin-button-group">
                            ...
                            <?php
                                $newsblogger_about_page=newsblogger_about_page();            
                                $newsblogger_actions = $newsblogger_about_page->recommended_actions;
                                ...
                                if($newsblogger_actions): 
                                    foreach ($newsblogger_actions as $key => $newsblogger_val):
                                        if($newsblogger_val['id']=='install_spice-starter-sites'):
                                            /* translators: %s: theme name */
                                            echo '<p class="newscrunch-import-btn">'.wp_kses_post($newsblogger_val['link']).'</p>';
                                        endif;
                                    endforeach;
                            endif;?>
                        </div>
                ...
                <div class="notice-content-wrap">
                    ...
                    <div class="notice-content">
                        ...
                        <ol class="admin-notice-up-list">
                            <li><?php echo 'Added markup setting for the single post title.'; ?></li>
                        </ol>
