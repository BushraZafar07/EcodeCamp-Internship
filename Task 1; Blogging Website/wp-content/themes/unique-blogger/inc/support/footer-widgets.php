 ...
 * @since 1.0.0
 */
class Unique_Blogger_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'unique_blogger';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'unique-blogger' ), $i ),
...
// Initialize.
$Unique_Blogger_Footer_Widgets = new Unique_Blogger_Footer_Widgets();