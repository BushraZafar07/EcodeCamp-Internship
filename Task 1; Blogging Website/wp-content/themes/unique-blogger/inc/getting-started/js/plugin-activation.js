jQuery(document).ready(function($) {
    'use strict';
    var this_obj = unique_blogger_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.unique-blogger-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message unique-blogger-plugin-install');
                button.addClass('button-primary unique-blogger-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.unique-blogger-recommended-plugins .unique-blogger-activation-note').css('display','block');
    ...
    $(document).on('click', '.unique-blogger-plugin-activate', function(event) {
