 ...
 */
class Unique_Blogger_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-blogger' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-blogger-customize-controls' );
		wp_enqueue_script( 'unique-blogger-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Blogger_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
